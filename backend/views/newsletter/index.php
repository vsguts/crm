...
<div class="newsletter-index">
    ...
    <?= GridView::widget([
        ...
        'columns' => [
            ...
            ['class' => 'common\widgets\grid\CounterColumn', 'label' => __('Mailing lists'), 'countField' => 'mailingListsCount'],
            ['class' => 'common\widgets\grid\CounterColumn', 'label' => __('Logs'), 'countField' => 'logsCount'],
