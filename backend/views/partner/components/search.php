            ...
            <ul class="nav nav-pills">
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <?= $form->field($model, 'publicTags')->label(__('Publ. tags'))->widget('common\widgets\form\Tags', ['placeholder_from_label' => 1]); ?>

                        <?= $form->field($model, 'personalTags')->label(__('Pers. tags'))->widget('common\widgets\form\Tags', ['placeholder_from_label' => 1]); ?>
