...
class m141031_200922_first extends Migration
{
    public function up()
    {
        ...
        $this->createTable('partner', [
            ...
            'volunteer'  => Schema::TYPE_SMALLINT . ' NOT NULL DEFAULT 0',
            'candidate'  => Schema::TYPE_SMALLINT . ' NOT NULL DEFAULT 0',
        ...
        $this->createTable('print_template', [
            ...
            'wrapper_enabled'       => Schema::TYPE_SMALLINT . ' NOT NULL DEFAULT 0',
