...
use app\models\behaviors\AuthItemBehavior;
...
class AuthItem extends AbstractModel
{
    ...
    {
        return AuthItemChild::find()->getLinkItemNames($this->name, 'inherited', Item::TYPE_PERMISSION);
    }
    ...
    public function getRolesInherited()
    {
        return AuthItemChild::find()->getLinkItemNames($this->name, 'inherited', Item::TYPE_ROLE);
    }
    ...
    public function getObjectsInherited($objectName)
    {
        return $this->find()->getRoleObjectsInherited()[$this->name][$objectName];
    }
